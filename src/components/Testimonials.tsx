...
/**
 * Testimonials will be populated with real member quotes after launch.
 * Author/contributor quotes pending permission from Nick Lockett,
 * Darren Sylvester, and Sushila Nair.
 */
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
          {[
            ...
            { title: "Name your price", detail: "Founding member rate locked in for 12 months — before standard pricing applies." },
            { title: "Direct author access", detail: "Rajiv, Nick, Darren, and Sushila are in the community from day one." },
          ].map((b) => (
            <div key={b.title} className="rounded-xl bg-white border border-ink-100 p-5 text-center">

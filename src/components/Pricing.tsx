...
const tiers = [
  ...
  },
  {
    ...
    price: "£299",
    period: "/month",
    description: "Structured implementation support with named accountability — not just access to content.",
    cta: "Talk to us",
    ctaHref: "mailto:raj@ai-integ.com",
    primary: false,
    features: [
      "Everything in Member",
      "5 team seats (onboard your whole practice)",
      "Quarterly 1:1 strategy call with Rajiv (45 min, recorded)",
      "Bespoke AI tool selection review for your firm",
      "Custom staff training template tailored to your sector",
      "Priority support — direct email response within 24 hours",
      "Referral to ASIMOV formal 251-control audit if needed",
    ],
  },
];
